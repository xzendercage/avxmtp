...
'''
           ...
           purposes! AVXMTP X1 shall not be used for any kind of illegal
        ...
        | RELEASE:      X (final version, 2021-05-07)                       |
        | AUTHOR:       Xzendercage @ GitHub.com                            |
        +===================================================================+
        | Based on AVXMTP X1, this is the new and improved version.         |
        ...
        | AVXMTP X1 is faster and more reliable, still providing support    |
...
try:
    ...
    sys.exit('[ERROR] Cannot import the needed Python modules!'
             + '\nCheck dependencies and start AVXMTP X1 again.\n\n')
...
try:
    ...
    sys.exit(colorama.Fore.RED + '\n\n[ERROR] File "library.json" not found!\n'
             + 'Check the file and start AVXMTP X1 again.\n\n')
...
def setdefaults():
    ...
    try:
        ...
        default_threads = int(9)
        print(colorama.Fore.RED + f'\nNo change, AVXMTP X1 will use {str(default_threads)} threads.\n')
    # set default timeout:
    try:
...
def proxysupport():
    ...
    print(colorama.Fore.YELLOW + '\n\n### AVXMTP X1 ###  |  DE-/ACTIVATE PROXY-SUPPORT:\n' + '-'*51 + '\n\n')
...
def deliverytest(smtphost, smtpport, smtpuser, smtppass, smtpemail, proxyip, proxyport):
    ...
    try:
        ...
        letter.add_header('From', str(f'AVXMTPX1 <{smtpemail}>'))
        letter.add_header('To', str(f'AVXMTP User <{attacker_mail}>'))
...
def attacker(attackid, target):
    ...
    global hits
    # set attacker ID:
    attacker_id = str(f'AVXMTP#{str(attackid)}')
...
main_logo = '''
            ...
            ################## XzenderCage @ GitHub.Com ##################
                        ▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
                        █░▄▄▀██░███░█▄▀█▀▄██░▄▀▄░█▄▄░▄▄██░▄▄░
                        █░▀▀░███░█░████░████░█░█░███░████░▀▀░
                        █░██░███▄▀▄██▀▄█▄▀██░███░███░████░███
                        ▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀                 
            (donations):        btc = 3PLbm6pypKCEz7QReFRTet7bqekEnx7S66
...
if legal_confirm in ['n', 'no', 'NO']:
    clean()
    sys.exit(colorama.Fore.RED
             + '\nLegal Notices not confirmed.\nAVXMTP X1 cannot be used without confirming the '
             + '<< Legal Notices >>.\n\n')
else:
    pass
# start main menu:
